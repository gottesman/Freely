...
import PlaylistInfoTab from './CenterPanel/PlaylistInfo';
import ArtistInfoTab from './CenterPanel/ArtistInfo';
import SearchResults from './CenterPanel/SearchResults';
import Settings from './CenterPanel/Settings';
import Tests from './CenterPanel/Tests';
